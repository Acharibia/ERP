...
import { BreadcrumbItem, EmployeeBasic, LeaveRequestForm, LeaveTypeBasic } from '@/types';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Request', href: '/modules/hr/leaves/create' },
];

export default function CreateLeaveRequest({ employees, leaveTypes }: { employees: EmployeeBasic[]; leaveTypes: LeaveTypeBasic[] }) {
    const { data, setData, post, processing, errors } = useForm<LeaveRequestForm>({
        employee_id: 0,
        leave_type_id: 0,
        start_date: '',
        end_date: '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('modules.hr.leaves.store'));
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <Card className={errors.priority ? 'border-red-500' : ''}>
                    ...
                    <CardContent>
                        <RadioGroup defaultValue={data.priority} onValueChange={(value) => setData('priority', value)}>
