...
import { BreadcrumbItem, DepartmentBasic, EmploymentTypeOption, PositionFormData, PositionLevelOption } from '@/types';
...
export default function Create({ departments, employmentTypes, positionLevels }: CreateProps) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Create',
            href: '/modules/hr/positions/create',
        },
    ];
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('modules.hr.positions.store'), {
            onSuccess: () => {
                toast.success('Position created successfully!', {
                    description: 'The new position has been added to the system.',
                    duration: 4000,
                });
            },
        });
